...
const API_KEY = "API_KEY"; // استبدل بمفتاح API الخاص بك
...
const GOOGLE_DRIVE_API_KEY = "GOOGLE_DRIVE_API_KEY"; // استبدل بـ API Key الخاص بك
const mainFolderId = "mainFolderId"; // معرف المجلد الرئيسي
...
// عند تحميل الصفحة أو الانتقال إلى صفحة جديدة
window.history.pushState(null, document.title, window.location.href);

// الاستماع لحدث الضغط على زر الرجوع
window.addEventListener("popstate", function(event) {
    window.history.go(1);  // العودة إلى الصفحة التالية في سجل التصفح
});